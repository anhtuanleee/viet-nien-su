    ...
    <main className="legal-page">
      ...
      <article className="legal-content">
        <header className="legal-hero">
          <p className="event-kicker">Cập nhật 16/08/2026</p>
        ...
        <section className="legal-section">
          <span>01</span><div><p className="event-kicker">Dữ liệu người dùng</p><h2>Trang web không có biểu mẫu thu thập thông tin</h2><p>Phiên bản hiện tại không cung cấp đăng ký tài khoản, bình luận, thanh toán, tải tệp hoặc biểu mẫu liên hệ. Chủ sở hữu không chủ động yêu cầu tên, email, số điện thoại, địa chỉ hay thông tin định danh khác qua trang web.</p></div>
        </section>
        <section className="legal-section">
        ...
        <section className="legal-section">
          <span>04</span><div><p className="event-kicker">Thay đổi</p><h2>Chính sách sẽ được cập nhật khi tính năng thay đổi</h2><p>Nếu dự án bổ sung tài khoản, phân tích người dùng, biểu mẫu hoặc dịch vụ mới có xử lý dữ liệu cá nhân, nội dung trang này cần được cập nhật trước hoặc cùng thời điểm tính năng được đưa vào sử dụng.</p></div>
        </section>
      </article>
      <SiteFooter />
    </main>
