  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content">
        ...
        <section className="legal-section">
          <span>02</span><div><p className="event-kicker">Phục dựng lịch sử</p><h2>Đường biên cổ đại chỉ mang tính minh họa</h2><p>Nhiều thời kỳ lịch sử không có đường biên chính xác theo cách hiểu hiện đại. Các vùng kiểm soát, tự trị và ảnh hưởng trên bản đồ là mô hình phục dựng có mức độ bất định, được đơn giản hóa để hỗ trợ quan sát và không biểu thị lập trường pháp lý về lãnh thổ hiện tại.</p></div>
        </section>
        <section className="legal-section">
